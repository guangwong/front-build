...
_.extend(App, /** @lends App */{
    ...
    init: function(dir, callback) {
        dir = path.join(dir);
        var json_path = path.join(dir, App.FB_JSON_NAME);
...
_.extend(App.prototype, events.EventEmitter.prototype, /** @lends App.prototype */{
    ...
    watchUtilsDir: function () {
        var self = this;
        console.log('watching ', self.getUtilsDir());
        var wd = watchDir(self.getUtilsDir());
