...
_.extend(Page.prototype, {
    ...
    _loadPlugins: function(callback) {
        ...
        self.use(require('./plugins/base-files')(pluginConfig));
    ...
    _buildTarget: function (timestamp, callback) {
        ...
        async.series([
            ...
            function (callback) {
                    reports.build_version = self.version;
                    reports.build_start_time = startTime;
                    reports.build_used_time = new Date().getTime() - startTime.getTime();
                    fu.writeJSON(path.resolve(self.timestampDir, Page.BUILD_JSON_NAME), reports, callback);
            }
    ...
    _execPlugin: function(callback) {
        ...
        async.mapSeries(self._plugins, function(plugin, callback) {
            ...
            return callback(null, pluginReports);
        });
    ...
    _startBuild: function (callback) {
        ...
        async.series([
            ...
            function (callback) {
                ...
                fs.mkdirp(path.resolve(self.timestampDir, 'page'), callback);
            }
        ], callback);
    },
